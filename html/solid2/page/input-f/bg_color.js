...
// background 또는 background-color 속성에서만 컬러 값 추출 여부 확인
function isColorProperty(content, position) {
    ...
    // "background" 또는 "background-color" 속성 매칭
    // 패턴: 시작/공백/줄바꿈/중괄호 뒤에 "background" 또는 "background-color"가 오고, 그 뒤에 공백과 콜론/등호
    // 예: "background:", " background:", "\nbackground:", "{background:", ";background:"
    // 예: "background-color:", " background-color:", "\nbackground-color:", "{background-color:", ";background-color:"
    
    // "background" 또는 "background-color" 속성 매칭
    // 패턴: (시작 또는 공백/중괄호/세미콜론) + "background" 또는 "background-color" + 공백 + (콜론 또는 등호)
...
// Hex 컬러 값 추출 (background 또는 background-color 속성만)
function extractHexColors(content) {
    ...
    while ((match = hexPattern.exec(cleanContent)) !== null) {
        ...
        // background 또는 background-color 속성에서만 추출
        if (isColorProperty(cleanContent, position)) {
            ...
            if (rgb) {
                ...
                const isBackgroundColor = /background-color\s*[:=]/.test(propertyText);
                
                colors.push({
                    value: hex.toLowerCase(),
                    rgb: rgb,
                    type: 'hex',
                    property: isBackgroundColor ? 'background-color' : 'background'
                });
            }
        }
    }
...
// RGBA 컬러 값 추출 (background 또는 background-color 속성만)
...
<head>
    ...
    <title>CSS Background/Background-Color 속성 색상 추출 결과</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1>🎨 CSS Background/Background-Color 속성 색상 추출 결과</h1>
        <div class="summary">
...
function main() {
    ...
    if (args.length < 1) {
        console.log('사용법: node bg_color.js <css파일경로 또는 css폴더경로> [출력파일경로]');
        console.log('\n예시:');
    ...
    console.log('🚀 CSS Background/Background-Color 속성 색상 추출 스크립트 시작\n');
