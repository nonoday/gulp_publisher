class SolidButton extends HTMLElement {
    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <button class="${buttonClasses}" ${this.disabled ? 'disabled' : ''} type="button" tabindex="0">
                ${leftIconSlot ? '<span class="solid-button-left-icon"><slot name="leftIcon"></slot></span>' : ''}
                <span class="solid-button-label">${this.label}</span>
                ${rightIconSlot ? '<span class="solid-button-right-icon"><slot name="rightIcon"></slot></span>' : ''}
    ...
    getStyles() {
        return `
            ...
            .solid-button.solid-button-size-xl .solid-button-label {
            ...
            .solid-button.solid-button-size-xl .solid-button-left-icon {
            width: 24px;
            height: 24px;
            }

            .solid-button.solid-button-size-xl .solid-button-right-icon {
            width: 24px;
            height: 24px;
            }

            .solid-button.solid-button-size-xl.solid-button-variant-underline .solid-button-label {
            padding: 0;
            ...
            .solid-button.solid-button-size-l .solid-button-label {
            padding: var(--spacing-none) var(--spacing-sm);
            ...
            .solid-button.solid-button-size-l .solid-button-left-icon {
            width: 20px;
            height: 20px;
            }

            .solid-button.solid-button-size-l .solid-button-right-icon {
            width: 20px;
            height: 20px;
            }

            .solid-button.solid-button-size-l.solid-button-variant-underline .solid-button-label {
            padding: 0;
            font-size: var(--font-size-title-l);
            line-height: var(--lineheight-title-l);
            }

            .solid-button.solid-button-size-l.solid-button-variant-outline .solid-button-label {
            padding: var(--spacing-none) var(--spacing-sm);
            font-size: var(--font-size-body-l);
            line-height: var(--lineheight-body-l);
            }
            ...
            .solid-button.solid-button-size-m .solid-button-label {
            padding: var(--spacing-none) var(--spacing-sm);
            ...
            .solid-button.solid-button-size-m .solid-button-left-icon {
            width: 16px;
            height: 16px;
            }

            .solid-button.solid-button-size-m .solid-button-right-icon {
            width: 16px;
            height: 16px;
            }

            .solid-button.solid-button-size-m.solid-button-variant-underline .solid-button-label {
            padding: 0;
            ...
            .solid-button.solid-button-size-s .solid-button-label {
            padding: var(--spacing-none) var(--spacing-sm);
            ...
            .solid-button.solid-button-size-s .solid-button-left-icon {
            width: 14px;
            height: 14px;
            }

            .solid-button.solid-button-size-s .solid-button-right-icon {
            width: 14px;
            height: 14px;
            }

            .solid-button.solid-button-size-s.solid-button-variant-underline .solid-button-label {
            padding: 0;
            font-size: var(--font-size-body-m);
            line-height: var(--lineheight-body-m);
            }
            ...
            .solid-button.solid-button-size-xs .solid-button-label {
            ...
            .solid-button.solid-button-size-xs .solid-button-left-icon {
            width: 12px;
            height: 12px;
            }

            .solid-button.solid-button-size-xs .solid-button-right-icon {
            width: 12px;
            height: 12px;
            }

            .solid-button.solid-button-size-xs.solid-button-variant-underline .solid-button-label {
            padding: 0;
            ...
            /* Label Element */
            .solid-button .solid-button-label {
            position: relative;
            ...
            /* icons */
            .solid-button .solid-button-left-icon {
            display: flex;
            align-items: center;
            justify-content: start;
            }

            .solid-button .solid-button-right-icon {
            display: flex;
            align-items: center;
            justify-content: end;
            }
...
(function() {
    ...
    if (!window.customElements) {
        ...
        function createFallbackButton(element) {
            ...
            // HTML 구조 생성
            button.innerHTML = `
                <span class="solid-button-left-icon">
                    ${leftIcon ? leftIcon.outerHTML : ''}
                </span>
                <span class="solid-button-label">${label}</span>
                <span class="solid-button-right-icon">
